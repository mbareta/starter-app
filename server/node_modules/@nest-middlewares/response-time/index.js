...
let ResponseTimeMiddleware = ResponseTimeMiddleware_1 = class ResponseTimeMiddleware {
    ...
    use(req, res, next) {
        if (ResponseTimeMiddleware_1.options) {
            (0, response_time_1.default)(ResponseTimeMiddleware_1.options)(req, res, next);
        }
        else {
...
exports.ResponseTimeMiddleware = ResponseTimeMiddleware = ResponseTimeMiddleware_1 = __decorate([
